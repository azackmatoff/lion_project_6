...
import 'package:lion_project_6/bloc/bloc_approach/bloc/quiz_bloc_state.dart';
...
class QuizBloc extends Bloc<QuizEvent, QuizBlocState> {
  ...
  void _clear(Emitter emit) {
    emit(QuizBlocState(icons: <Widget>[], question: service.nextQuestion(), isFinished: false));
  }
}
